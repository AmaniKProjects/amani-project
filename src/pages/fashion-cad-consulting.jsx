        ...
        <>
            <div className=" w-screen md:h-screen flex flex-col gap-y-5 justify-between content-center bg-gray-900" style={{fontFamily:'Rockwell'}}>
                ...
                <div className="pl-10 pr-10 md:pl-48 md:pr-48" style={{color:'#ffa200'}}>
                    <span className=" font-bold text-3xl">Fashion CAD Consulting and Implementation Services</span>
                    <br/>
                    <br/>
                    <span className=" text-lg">Our Training Services include:</span>
                    {/* <p>
                    Fashion products, by definition, have short life cycles. Fashion supply chain is hugely fragmented and traditional methods of fashion product development take a lot of time.<br/>Fashion  CAD enables shortening of product development time cycles, collaborative working between team members spread across geographies, enhance creativity and productivity, and reduce fabric consumption<br/> As the REACH Authorized Sutions Partner in Rwanda,  Amani K Fashion Creations Ltd.  offers consulting and implementation services on REACH CAD<br/>REACH CAD enables digital apparel pattern design, grading and marker planning
                    </p> */}
...
export default FashionCADConsulting;